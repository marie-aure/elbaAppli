 ...
 // enregistrer les starters
	...
	private List<LiaisonSITR> creerSims(int taille) {
		...
		for (int i = 0; i < taille; i++) {
			...
			starter.setPeau(rnd.nextInt(10));
			starter.setPoids(rnd.nextInt(10));
			starter.setMuscle(rnd.nextInt(10));
			starter.setPoitrine(rnd.nextInt(10));
			starter.setCheveux(rnd.nextInt(8));
			starter.setVisage(rnd.nextInt(12));
			starter.setCouleurYeux(rnd.nextInt(8));
			starter.setYeux(rnd.nextInt(15));
			starter.setNez(rnd.nextInt(24));
			starter.setBouche(rnd.nextInt(17));
			starter.setPlat(rnd.nextInt(51));
			starter.setMusique(rnd.nextInt(28));
			starter.setCouleur(rnd.nextInt(20));
			starter.setSigne(rnd.nextInt(12));
			starter.setGroupe(0);
